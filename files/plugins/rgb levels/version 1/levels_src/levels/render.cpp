...
void LevelsFilter::render_xrgb8()
{
  ...
  float mr1 = 0x100/(param.r.v2-param.r.v0);
  float mg1 = 0x100/(param.g.v2-param.g.v0);
  float mb1 = 0x100/(param.b.v2-param.b.v0);
  uint32 mr,mg,mb;
...
void LevelsFilter::render_xrgb64()
{
  ...
  float mr1 = 0x10000/(param.r.v2-param.r.v0)*dst_info.ref_r/src_info.ref_r;
  float mg1 = 0x10000/(param.g.v2-param.g.v0)*dst_info.ref_g/src_info.ref_g;
  float mb1 = 0x10000/(param.b.v2-param.b.v0)*dst_info.ref_b/src_info.ref_b;
  uint32 mr,mg,mb;
